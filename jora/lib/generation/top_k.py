...
def _loop_body_top_k(
    params: Llama,
    state: _TopKGenerationState,
    model_config: ModelConfig,
    top_k_config: TopKGenerationConfig,
) -> _TopKGenerationState:
...
def top_k(
    ...
    *,
    ...
    loop_body = lambda state: _loop_body_top_k(
        params, state, model_config, top_k_config
    )
    state = _TopKGenerationState(
